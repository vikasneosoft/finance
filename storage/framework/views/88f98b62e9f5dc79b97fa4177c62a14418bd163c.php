...
<?php $__env->startSection('employee-content'); ?>
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item">
                                <a href="<?php echo e(route('expenses.get_submited_expenses_by_employee')); ?>">Approval</a>
                            </li>
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="row mb-2">
                    <div class="col-12">
                        <?php if($rounting->approval_status == 0): ?>
                ...
                <div class="row">
                    <div class="col-12">
                        <?php if($rounting->approval_status == 0): ?>
                            <a data-budget="<?php echo e($expense['budget_id']); ?>" data-id="<?php echo e($expense['id']); ?>" class="reject-expense btn btn-danger float-right"
                                href="">Reject</a>
                            <a data-id=<?php echo e($expense['id']); ?> class="approve-expense btn btn-primary float-right"
                                href="">Approve</a>
                        <?php elseif($rounting->approval_status == 1): ?>
                            <span class="btn btn-primary float-right">Approved</span>
                        <?php else: ?>
                            <span class="btn btn-danger">Rejected by

                                <?php if(auth::user()->id == $rounting->rejectedBy['id']): ?>
                                    Me
                                <?php else: ?>
                                    <?php echo e($rounting->rejectedBy['name']); ?>

                                <?php endif; ?>
                            </span>
                            <span class="float-right">Reason : <?php echo e($rounting->reason); ?></span>
                        <?php endif; ?>
                    </div>
                </div>
        </section>
    ...
    <input type="hidden" id="reject-expense-route" value=<?php echo e(route('expenses.reject_expensees')); ?> />
...
<?php $__env->startSection('employee-js'); ?>
    ...
    <script src="<?php echo e(asset('public/js/approve-disapprove-expensive.js')); ?>"></script>
    <script>
...
<?php echo $__env->make('employee.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/finance/resources/views/employee/submited-expenses/expense-detail.blade.php ENDPATH**/ ?>