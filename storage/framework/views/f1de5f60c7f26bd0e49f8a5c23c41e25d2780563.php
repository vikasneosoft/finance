                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item">
                                <a href="<?php echo e(route('expenses.all_expenses')); ?>">All Expenses</a>
                            </li>
        ...
        <section class="content">
            <div class="container-fluid">
                                ...
                                <?php if(isset($expense)): ?>
                                    ...
                                    <?php $__currentLoopData = $expense['expense_detail']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr class="tr-<?php echo e($value['id']); ?>">
                                            ...
                                            <td><a id="more-detail" data-explanation="<?php echo e($value['expensive_explanation']); ?>" data-specification="<?php echo e($value['specifications']); ?>" href="#">More Detail</a></td>
                                            <td>
                                                <?php if($value['image']): ?>
                                                <a target="_blank"
                ...
                <?php if(in_array($expense['employee_id'], findUserOfSameLevel())): ?>
                    <div class="row">
                        <div class="col-3">
                            <?php if($expense['is_approved'] == 2): ?>
                                <?php if($expense['is_cloned'] == 0): ?>
                                    <a data-id="<?php echo e($expense['id']); ?>" class="create-clone btn btn-primary"
...
<?php echo $__env->make('employee.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/finance/resources/views/employee/submited-expenses/submitted-expense-detail.blade.php ENDPATH**/ ?>