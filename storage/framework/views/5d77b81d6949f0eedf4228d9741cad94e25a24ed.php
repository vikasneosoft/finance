...
<head>
    ...
    <title> Finance | <?php echo $__env->yieldContent('title'); ?> </title>
    ...
    <?php echo $__env->yieldContent('admin-css'); ?>
</head>
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown">
                    ...
                    <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow"
                        ...
                        <li><a href="<?php echo e(route('admin.logout')); ?>" class="dropdown-item">Logout</a></li>
                    </ul>
                </li>
            </ul>

        </nav>
<?php /**PATH /var/www/html/finance/resources/views/admin/header.blade.php ENDPATH**/ ?>