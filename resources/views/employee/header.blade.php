...
<head>
    ...
    <title> Budgeting App | @yield('title') </title>
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            <div style="margin-left: 10px" class="navbar-nav row col-md-offset-2">
                ...
                @endif
                @if (isset(userDetail()->section['name']))
                || {{ userDetail()->section['name'] }}
                @endif
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown">
                    ...
                    <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow"
                        ...
                        <li><a href="{{ route('employee.logout') }}" class="dropdown-item">Logout</a></li>
                    </ul>
                </li>
            </ul>
