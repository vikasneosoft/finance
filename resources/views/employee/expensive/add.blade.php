                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-offset-2 col-md-6">
                                        <div class="form-group">
                                            ...
                                            @if (count($fincialYears))
                                                {{ Form::select('financial_year_name', array_replace(['' => 'Select'], $fincialYears), $budget->financial_year, ['class' => 'form-control', 'disabled' => true]) }}
                                                {{ Form::hidden('financial_year', $budget->financial_year) }}
                                            @else
                                                {{ Form::select('financial_year', ['' => 'No Record'], null, ['class' => 'form-control']) }}
                                            @endif
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if (count($projectCodes))
                                                {{ Form::select('project_code_id_read', array_replace(['' => 'Select'], $projectCodes), $budget->project_code_id, ['class' => 'form-control', 'disabled' => true]) }}
                                                {{ Form::hidden('project_code_id', $budget->project_code_id) }}
                                            @else
                                                {{ Form::select('project_code_id', ['' => 'No Record'], null, ['class' => 'form-control']) }}
                                            @endif
                                            <label class="d-none help-block error"></label>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-offset-2 col-md-6">
                                        <div class="form-group">
                                            ...
                                            @if (count($budgetTypes))
                                                {{ Form::select('budget_type_id_read', array_replace(['' => 'Select'], $budgetTypes), $budget->budget_type_id, ['class' => 'form-control', 'disabled' => true]) }}
                                                {{ Form::hidden('budget_type_id', $budget->budget_type_id) }}

                                            @else
                                                {{ Form::select('budget_type_id_read', ['' => 'No Record'], null, ['class' => 'form-control', 'id' => 'budget_type_id']) }}
                                            @endif
                                            <label class="d-none help-block error"></label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <span class="star">*</span>
                                            {{ Form::text('proj_ref_no', $budget->budget_proj_ref_no, ['id' => 'proj_ref_no', 'class' => 'form-control', 'readonly' => 'true']) }}
                                            <label class="d-none help-block error"></label>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-offset-2 col-md-6">
                                        <div class="form-group">
                                            ...
                                            @if (count($costCenters))
                                                {{ Form::select('cost_center_id_read', array_replace(['' => 'Select'], $costCenters), $budget->cost_center_id, ['class' => 'form-control', 'disabled' => true]) }}
                                                {{ Form::hidden('cost_center_id', $budget->cost_center_id) }}
                                            @else
                                                {{ Form::select('cost_center_id_read', ['' => 'No Record'], null, ['class' => 'form-control']) }}
                                            @endif
                                            <label class="d-none help-block error"></label>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            {{ Form::label('project_in_charge', 'Project Incharge: ', ['class' => 'control-label']) }}<span
                                                class="star">*</span>
                                            {{ Form::text('project_in_charge', $budget->project_in_charge, ['id' => 'project_in_charge', 'class' => 'form-control', 'readonly' => 'true']) }}
                                            <label class="d-none help-block error"></label>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-offset-2 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <span class="star">*</span>
                                            {{ Form::text('expensive_code', $budget->budget_code, ['id' => 'expensive_code', 'class' => 'form-control', 'readonly' => 'true']) }}
                                            <label class="d-none help-block error"></label>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="star">*</span>
                                        {{ Form::text('vendor', $budget->vendor, ['id' => 'vendor', 'class' => 'form-control', 'readonly' => 'true']) }}
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-md-offset-2 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <span class="star">*</span>
                                                {{ Form::text('vendor_contacts', $budget->vendor_contacts, ['id' => 'vendor_contacts', 'class' => 'form-control', 'readonly' => 'true']) }}
                                                <label class="d-none help-block error"></label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            <a href="{{ route('budget.get_budgets') }}"
