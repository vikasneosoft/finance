                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('expenses.get_submited_expenses') }}">Expenses</a>
                            </li>
                            ...
                            <tbody>
                                ...
                                @foreach ($expense['expense_detail'] as $value)
                                    ...
                                    <tr class="tr-{{ $value['id'] }}">
                                        ...
                                        {{-- <td style="text-align: right">{{ IND_money_format($value['submited_expense']) }} </td> --}}
                                        {{-- <td class="right-side-text">{{ IND_money_format($value['expense_balance']) }} </td> --}}
                                        ...
                                        <td>
                                            ...
                                            <a target="_blank"
                                                href="{{ URL::asset('/public/budget_images/' . $value['image']) }}">View File</a>
                                            @else
                                            --
                                            @endif
                                        </td>
