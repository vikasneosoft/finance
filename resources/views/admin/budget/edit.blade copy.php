        ...
        <div class="row">
            <div class="offset-md-3 col-md-6">
                <div class="card card-primary">
                    ...
                    @endif
                    {{ Form::model($budget, ['method' => 'POST', 'id' => 'edit-form', 'files' => true]) }}
                    {{ Form::hidden('action', 'edit') }}
                    {{ Form::hidden('id', $budget['id'], ['id' => 'id']) }}
                    @include('admin.budget.formElements',['submitButtonText' => 'Update'])
                    {{ Form::close() }}
                </div>
            </div>
        </div>
    ...
    $(document).ready(function() {
        ...
        $("#edit-form").validate({
            ...
            messages: {
                ...
                budget_quantity: {
                    required: "Budget quantity is required",
                },
                budget_rate: {
                ...
                budget_from_date: {
                    required: "Select budget from date",
                },
                budget_to_date: {
                    required: "Select budget to date",
                },
                budget_proj_ref_no: {
