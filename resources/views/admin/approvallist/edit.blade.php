            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Edit Approval list</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="offset-md-3 col-md-6">
                    <div class="card card-primary">
                        ...
                        @endif
                        {{ Form::model($approvalList, ['method' => 'POST', 'id' => 'edit-form', 'files' => true]) }}
                        {{ Form::hidden('action', 'edit') }}
                        {{ Form::hidden('id', $approvalList['id'], ['id' => 'id']) }}
                        @include('admin.approvallist.formElements',['submitButtonText' => 'Update'])
                        {{ Form::close() }}
                    </div>
                </div>
            </div>
            ...
            $("#edit-form").validate({
                ...
                submitHandler: function(form) {
                    $.ajax({
                        ...
                        url: "{{ route('approval-list.update', 'id') }}",
                        beforeSend: function() {
                            $("#loadingImage").css({
                                "display": "block"
                            });
