...
class CategoryStatus extends Migration
{
    ...
    private function dropView(): string
    {
        return <<<SQL
            ...
            DROP VIEW IF EXISTS `type_category_status`;
            SQL;
    }
}
